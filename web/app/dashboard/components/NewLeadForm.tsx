  ...
  return (
    <motion.div
      ...
      style={{
        ...
        background: "rgba(28,25,23,0.3)", backdropFilter: "blur(4px)",
    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 18 }}>
          ...
          <button onClick={onClose} className="transition" style={{
            width: 24, height: 24, display: "flex", alignItems: "center", justifyContent: "center",
            background: "none", border: "1px solid var(--b1)", borderRadius: 4, cursor: "pointer", color: "var(--t2)",
          }}>
            <X size={11} />
          </button>
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 11 }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 9 }}>
            {[
              { key: "name",  label: "Nome",  ph: "Ana Souza",       t: "text"  },
              { key: "email", label: "Email", ph: "ana@empresa.com", t: "email" },
            ].map(({ key, label, ph, t }) => (
              <div key={key}>
                <p className="label" style={{ marginBottom: 4 }}>{label}</p>
                <input type={t} style={field} placeholder={ph}
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 9 }}>
            <div>
              <p className="label" style={{ marginBottom: 4 }}>Empresa</p>
            ...
            <div>
              <p className="label" style={{ marginBottom: 4 }}>Origem</p>
          ...
          <div>
            <p className="label" style={{ marginBottom: 4 }}>Texto da interação</p>
            <textarea style={{ ...field, resize: "none" as const, lineHeight: 1.6 }} rows={5}
          ...
          <button onClick={submit} disabled={disabled} className="transition"
            style={{
              padding: "9px 0",
            ...
            onMouseEnter={e => { if (!disabled) (e.currentTarget as HTMLButtonElement).style.opacity = "0.83"; }}
